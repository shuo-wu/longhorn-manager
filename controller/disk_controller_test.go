...
func (s *TestSuite) TestSyncDisk(c *C) {
	...
	tc = &DiskTestCase{}
	tc.disks = map[string]*longhorn.Disk{
		TestDefaultDiskUUID2: newDisk(TestDefaultDiskUUID2, TestNamespace, TestNode1),
	}
	tc.nodes = map[string]*longhorn.Node{
		TestNode1: newNode(TestNode1, TestNamespace, TestDefaultDiskUUID1, true, types.ConditionStatusTrue, ""),
	}
	...
	disk1.Spec.Path = "/new-path"
	disk1.Status.FSID = ""
	disk1.Status.Conditions = map[string]types.Condition{}
	disk1.Status.State = ""
	tc.disks = map[string]*longhorn.Disk{
		TestDefaultDiskUUID1: disk1,
		TestDefaultDiskUUID2: newDisk(TestDefaultDiskUUID2, TestNamespace, TestNode1),
	...
	node1.Status.DiskPathIDMap = map[string]string{
		"/new-path":         TestDefaultDiskUUID1,
		TestDefaultDataPath: TestDefaultDiskUUID2,
	}
	tc.nodes = map[string]*longhorn.Node{
		TestNode1: node1,
	}
	tc.expectDiskStatus = map[string]types.DiskStatus{
		TestDefaultDiskUUID1: {
			OwnerID:          TestNode1,
			StorageScheduled: 0,
			StorageAvailable: 0,
			StorageMaximum:   0,
		...
		TestDefaultDiskUUID2: newDisk(TestDefaultDiskUUID2, TestNamespace, TestNode1).Status,
	}
